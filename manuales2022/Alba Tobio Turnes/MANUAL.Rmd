---
title: |
  ![](C:/Users/tsuba/OneDrive/Escritorio/bichos.png)
output: 
  html_document:
    df_print: paged
    theme: 
      ...
      heading_font:
        google: Patrick Hand
      headings_color: "#F38375"
---

```{r setup, include=FALSE}
if (requireNamespace("thematic")) 
  thematic::thematic_rmd(font = "auto")
knitr::opts_chunk$set(echo = TRUE, error = TRUE, comment = FALSE)
```
...
1.  [Introducción a R y Rstudio](#b1)

    1.1. [Definición de R](#b1.1)

    1.2. [Definición de Rstudio](#b1.2)

    1.3. [R vs. Rstudio](#b1.3)

    1.4. [¿Por qué utilizar R como lenguaje de programación?](#b1.4)

    1.5. [Exploración de R y Rstudio](#b1.5)

2.  [Programación básica](#b2)

    2.1. [Paquetes y librerías](#b2.1)

    2.1.1. [Concepto de función y vector](#b2.1.1)

    2.1.2. [Uso de paquetes y librerías, exploración de funciones](#b2.1.2)

    2.2. [La ayuda](#b2.2)

    2.3. [Directorio de trabajo](#b2.3)

    2.4. [Vectores](#b2.4)

    2.4.1. [Concepto de vector y propiedades](#b2.4.1)

    2.4.2. [Uso de vectores para obtener dataframes](#b2.4.2)

    2.4.3. [Diferencia entre lista y vector](#b2.4.3)

    2.4.4. [Operaciones básicas con vectores](#b2.4.4)

    2.5. [Otro tipo de objetos](#b2.5)

    2.6. [Recomendaciones de programación](#b2.6)

    2.6.1. [Recomendaciones de programación y flujo de trabajo en R](#b2.6.1)

    2.6.2. [Ejemplo completo](#b2.6.2)

3.  [Trabajo reproducible: desde programación colaborativa a control de versiones](#b3)

    3.1. [Obtención y tratamiento de datos: flujo de trabajo y tipos de datos](#b3.1)

    3.2. [GitHub](#b3.2)

    3.3. [Archivos rmd, Rmarkdown](#b3.3)

4.  [Obtención y tratamiento aplicado a la ciencia de datos](#b4)

    4.1. [Tidyverse](#b4.1)

    4.1.1. [¿Qué es tidyverse?](#b4.1.1)

    4.1.2. [Resolución de un problema ambiental con tidyverse](#b4.1.2)

    4.2. [Representación gráfica con ggplot](#b4.2)

    4.2.1. [Tipos de gráficos](#b4.2.1)

    4.2.2. [Sintaxis de ggplot](#b4.2.2)

5.  [Visualización de datos](#b5)

    5.1. [R como GIS](#b5.1)

    5.1.1. [¿Qué son los sistemas GIS o SIG?](#b5.1.1)
    
    5.1.2. [Utilización de R como GIS](#b5.1.2)
    
    5.1.3. [Ejemplos de su uso](#b5.1.3)
    
    5.1.4. [Extracción de datos biológicos de la distribución de las  especies a partir de GBIF](#b5.1.4)
    
    5.1.5. [Extracción de información apartir de raster, uso del paquete raster](#b5.1.5)
    
    5.2. [Mapas de puntos con ggplot](#b5.2)


------------------------------------------------------------------------

# 1. Introducción a R y Rstudio <a name="b1"></a>

En este primer bloque nos familiarizamos con R y Rstudio.

## 1.1. Definición de R <a name="b1.1"></a>
...
## 1.2. Definición de Rstudio <a name="b1.2"></a>
...
## 1.3. R vs. Rstudio <a name="b1.3"></a>
...
## 1.4. ¿Por qué utilizar R como lenguaje de programación? <a name="b1.4"></a> {.tabset .tabset-pills}
...
## 1.5. Exploración de R y Rstudio <a name="b1.5"></a>
...
# 2. Programación básica <a name="b2"></a>

Hemos revisado conceptos básicos sobre R.

## 2.1. Paquetes y librerías <a name="b2.1"></a>

### 2.1.1. Concepto de función y vector <a name="b2.1.1"></a>
...
### 2.1.2. Uso de paquetes y librerías, exploración de funciones <a name="b2.1.2"></a> {.tabset .tabset-pills}
...
## 2.2. La ayuda <a name="b2.2"></a> {.tabset .tabset-pills}
...
## 2.3. Directorio de trabajo <a name="b2.3"></a> {.tabset .tabset-pills}
...
## 2.4. Vectores <a name="b2.4"></a>

### 2.4.1. Concepto de vector y propiedades <a name="b2.4.1"></a> {.tabset .tabset-pills}
...
#### Ejemplo 1: entender las propiedades de los vectores {.tabset .tabset-pills}
...
#### Ejemplo 2: trabajo con figuras {.tabset .tabset-pills}
...
### 2.4.2. Uso de vectores para obtener dataframes <a name="b2.4.2"></a> {.tabset .tabset-pills}
...
### 2.4.3. Diferencia entre lista y vector <a name="b2.4.3"></a>
...
### 2.4.4. Operaciones básicas con vectores <a name="b2.4.4"></a> {.tabset .tabset-pills}
...
## 2.5. Otro tipo de objetos <a name="b2.5"></a>
...
## 2.6. Recomendaciones de programación <a name="b2.6"></a>

En este apartado vamos a ver recomendaciones para la escritura del código.

### 2.6.1. Recomendaciones de programación y flujo de trabajo en R <a name="b2.6.1"></a> {.tabset .tabset-pills}
...
### 2.6.2. Ejemplo completo <a name="b2.6.2"></a>
...
# 3. Trabajo reproducible: desde programación colaborativa a control de versiones <a name="b3"></a>
...
## 3.1.Obtención y tratamiento de datos: flujo de trabajo y tipos de datos <a name="b3.1"></a>
...
## 3.3. Archivos rmd, Rmarkdown <a name="b3.3"></a>
...
# 4. Obtención y tratamiento aplicado a la ciencia de datos <a name="b4"></a>

A lo largo de este bloque aprenderemos a manejar los datos y a visualizarlos por medio de diferentes tipos de gráficos. En este bloque trabajaremos mayoritariamente con el paquete `ggplot`de `tidyverse`.

## 4.1. Tidyverse <a name="b4.1"></a>

### 4.1.1. ¿Qué es tidyverse? <a name="b4.1.1"></a>
...
### 4.1.2. Resolución de un problema ambiental con tidyverse <a name="b4.1.2"></a> {.tabset .tabset-pills}
...
-   Vamos a representar comoa medida que aumenta el CO~2~ aumenta la temperatura, de esta manera el CO~2~ es la variable independiente y temperatura es la dependiente. De esta manera mostramos que existe el cambio climático.

-   Para evidenciar el efecto del ser humano en el cambio climático podemos ver como varían la temperatura y niveles de CO~2~ con el tiempo y luego disgregar los datos de CO~2~ en sectores para ver su origen.

#### A. Descargar los datos

Antes de comenzar a utilizar `tidyverse` debemos descargar los datos climáticos y de CO~2~ para Alcalá de Henares, para esto utilizaremos el paquete `easyclimate`:
...
#### B. Uso de readr {.tabset .tabset-pills}
...
#### E. Uso de tidyr: datos tidy o tidy data {.tabset .tabset-pills}
...
En el formato largo haremos que solo existan 3 variables: - una para los niveles de CO~2~ - otra para los años - una final para los países
...
#### F. Uso de dplyr: manipulación de datos {.tabset .tabset-pills}
...
En este código hemos dicho que la columna "year" de temperatura es igual que la columna " co_year" de los datos de CO~2~, y hemos unido las dos bases por medio de esta columna. Ahora que se han unido nos queda organizar un poco la información, si nos fijamos en nuestro nuevo tibble `co_temp` veremos que existen varios valores de temperatura repetidos por sectores donde se ha medido el nivel de CO~2~. Lo que sucede es que la temperatura anual media en Alcalá de Henares es igual para cualquiera de los sectores pero no lo son los niveles de CO~2~ emitidos, por lo que para los datos de CO~2~debemos realizar la suma de los niveles de dióxido de carbono por sector,por ello usaremos la función `summarise`. Mientras que en el caso de la temperatura debemos eliminar los valores repetidos, por ello nos quedaremos con los primeros valores de temperatura que aparecen por año utilizando la función `first`. Estas funciones las aplicaremos de forma simultánea, pero hay un inconveniente y es que no se puede realizar la suma de los niveles de CO~2~ por sector tal cual debido a que esta variable está definida como un factor, por ello, antes de nada utilizaremos `mutate` para transformarla en numérica.
...
### 4.2.2. Sintaxis de ggplot <a name="b4.2.2"></a> {.tabset .tabset-pills}
...
También vamos a cargar los datos con los que vamos a trabajar, en estos datos se recoge información sobre los seismos y niveles de SO~2~ por región sobre la erupción de la Palma que ha sucedido este mismo año, en el primer dataframe. En el segundo dataframe se recoge información más detallada sobre los seísmos (como la profundidad o magnitud de estos), además de otra información como la temperatura.
...
#### C. Nubes de puntos {.tabset .tabset-pills}
...
#### D. Boxplots {.tabset .tabset-pills}
...
# 5. Visualización de datos, GIS y mapas <a name="b5"></a> 

A lo largo de este bloque trabajaremos en la creación de mapas y en el uso de R como GIS


## 5.1. R como GIS <a name="b5.1"></a> 


### 5.1.1. ¿Qué son los sistemas GIS o SIG? <a name="b5.1.1"></a> 
...
### 5.1.2. Utilización de R como GIS <a name="b5.1.2"></a> {.tabset .tabset-pills}
...
#### C. Otras formas de visualizar mapas con R {.tabset .tabset-pills}
...
Comenzamos abriendo una ventana para dibujar el mapa usando la función `mapDevice`, a continuación usamos la función `map`y definimos varios elementos:
...
### 5.1.3. Ejemplos de su uso <a name="b5.1.3"></a> {.tabset .tabset-pills}
...
### 5.1.4: Extracción de datos biológicos de la distribución de las  especies a partir de GBIF <a name="b5.1.4"></a> {.tabset .tabset-pills}
...
### 5.1.5. Extracción de información apartir de raster, uso del paquete raster<a name="b5.1.5"></a>
...
## 5.2. Mapas de puntos con ggplot: <a name="b5.2"></a> 
